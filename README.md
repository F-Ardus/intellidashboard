...
A React + TypeScript threat intelligence dashboard built as a front-end take-home assignment. Displays, filters, and explores security indicators against a live mock API.
...
| Midnight | Light |
|---|---|
| ![Midnight theme](docs/midnight.png) | ![Light theme](docs/light.png) |

| Forest | Dusk | Terminal |
|---|---|---|
| ![Forest theme](docs/forest.png) | ![Dusk theme](docs/dusk.png) | ![Terminal theme](docs/terminal.png) |
